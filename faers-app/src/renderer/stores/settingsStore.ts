  ...
  loadSettings: async () => {
    ...
    try {
      const [
        ...
        window.electronAPI.getSetting('senderAddress'),
        window.electronAPI.getSetting('senderCity'),
        window.electronAPI.getSetting('senderState'),
        window.electronAPI.getSetting('senderPostcode'),
        window.electronAPI.getSetting('senderCountry'),
      ...
      set({
        settings: {
          ...
          senderOrganization: senderOrgRes.data || defaultSettings.senderOrganization,
          senderAddress: senderAddressRes.data || defaultSettings.senderAddress,
          senderCity: senderCityRes.data || defaultSettings.senderCity,
          senderState: senderStateRes.data || defaultSettings.senderState,
          senderPostcode: senderPostcodeRes.data || defaultSettings.senderPostcode,
          senderCountry: senderCountryRes.data || defaultSettings.senderCountry,
