<?xml version="1.0" encoding="UTF-8"?><MCCI_IN200101UV01 xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ITSVersion="XML_1.0" xsi:schemaLocation="urn:hl7-org:v3 MCCI_IN200101UV01.xsd">
	<id extension="3232706165" root="2.16.840.1.113883.3.989.2.1.3.20"/>
	<!-- ACK.M.1: Acknowledgement Batch Number -->
	<creationTime value="20260603031337-0400"/>
	...
	<!-- Ack Message #1 -->
	<MCCI_IN000002UV01>
		<id extension="895352" root="2.16.840.1.113883.3.989.2.1.3.19"/>
		...
		<acknowledgement typeCode="CR">
			...
			<targetMessage>
				<id extension="SR-CASE-20260603-TCB02" root="2.16.840.1.113883.3.989.2.1.3.1"/>
...
1: Country of Authorisation / Application (G.k.3.2) should be entered when Authorisation / Application Number (G.k.3.1) is entered.
	...
	<attentionLine>
		...
		<value extension="810637" root="2.16.840.1.113883.3.989.2.1.3.21" xsi:type="II"/>
	...
	<acknowledgement typeCode="AR">
		...
		<targetBatch>
			<id extension="DeepQuenceTest-20260603-ea020169-fdc5-4c32-bf7a-baf3261b4915" root="2.16.840.1.113883.3.989.2.1.3.22"/>
