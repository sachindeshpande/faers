<?xml version="1.0" encoding="UTF-8"?><MCCI_IN200101UV01 xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ITSVersion="XML_1.0" xsi:schemaLocation="urn:hl7-org:v3 MCCI_IN200101UV01.xsd">
	<id extension="3232706205" root="2.16.840.1.113883.3.989.2.1.3.20"/>
	...
	<!-- Ack Message #1 -->
	<MCCI_IN000002UV01>
		<id extension="895362" root="2.16.840.1.113883.3.989.2.1.3.19"/>
		...
		<acknowledgement typeCode="CR">
			...
			<targetMessage>
				<id extension="SR-CASE-20260603-TCB01" root="2.16.840.1.113883.3.989.2.1.3.1"/>
...
1: Country of Authorisation / Application (G.k.3.2) should be entered when Authorisation / Application Number (G.k.3.1) is entered.
	...
	<attentionLine>
		...
		<value extension="810650" root="2.16.840.1.113883.3.989.2.1.3.21" xsi:type="II"/>
	...
	<acknowledgement typeCode="AR">
		...
		<targetBatch>
			<id extension="DeepQuenceTest-20260603-5e00368d-63c9-4e79-9697-7e067db45a21" root="2.16.840.1.113883.3.989.2.1.3.22"/>
