<?xml version="1.0" encoding="UTF-8"?><MCCI_IN200101UV01 xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ITSVersion="XML_1.0" xsi:schemaLocation="urn:hl7-org:v3 MCCI_IN200101UV01.xsd">
	<id extension="3232717899" root="2.16.840.1.113883.3.989.2.1.3.20"/>
	<!-- ACK.M.1: Acknowledgement Batch Number -->
	<creationTime value="20260603230139-0400"/>
	...
	<!-- Ack Message #1 -->
	<MCCI_IN000002UV01>
		<id extension="895652" root="2.16.840.1.113883.3.989.2.1.3.19"/>
		...
		<acknowledgement typeCode="CR">
			...
			<targetMessage>
				<id extension="SR-CASE-20260603-INDT03" root="2.16.840.1.113883.3.989.2.1.3.1"/>
...
2: FDA.C.5.6.r is invalid for the Center specified in N.2.r.3.
	...
	<attentionLine>
		...
		<value extension="810922" root="2.16.840.1.113883.3.989.2.1.3.21" xsi:type="II"/>
	...
	<acknowledgement typeCode="AR">
		...
		<targetBatch>
			<id extension="DeepQuenceTest-20260603-b050c6f2-719c-432a-bcb0-349d9f89215e" root="2.16.840.1.113883.3.989.2.1.3.22"/>
