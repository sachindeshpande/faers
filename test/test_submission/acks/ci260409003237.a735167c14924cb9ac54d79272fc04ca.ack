<?xml version="1.0" encoding="UTF-8"?><MCCI_IN200101UV01 xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ITSVersion="XML_1.0" xsi:schemaLocation="urn:hl7-org:v3 MCCI_IN200101UV01.xsd">
	<id extension="3229561306" root="2.16.840.1.113883.3.989.2.1.3.20"/>
	<!-- ACK.M.1: Acknowledgement Batch Number -->
	<creationTime value="20260408203736-0400"/>
	...
	<!-- Ack Message #1 -->
	<MCCI_IN000002UV01>
		<id extension="836674" root="2.16.840.1.113883.3.989.2.1.3.19"/>
...
Rejections:
1: Data value required for tag C.3.3.3.
2: C.3.2 must be provided when C.3.1 is not coded as 7 (Patient / Consumer).
</text>
	...
	<attentionLine>
		...
		<value extension="752539" root="2.16.840.1.113883.3.989.2.1.3.21" xsi:type="II"/>
	...
	<acknowledgement typeCode="AR">
		...
		<targetBatch>
			<id extension="DeepQuenceTest-20260408-v32-b3e9f021-7c4a-4d1b-a8e3-6c0f5d2b7e94" root="2.16.840.1.113883.3.989.2.1.3.22"/>
