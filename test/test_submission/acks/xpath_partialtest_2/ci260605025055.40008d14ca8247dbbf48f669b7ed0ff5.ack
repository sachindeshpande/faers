<?xml version="1.0" encoding="UTF-8"?><MCCI_IN200101UV01 xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ITSVersion="XML_1.0" xsi:schemaLocation="urn:hl7-org:v3 MCCI_IN200101UV01.xsd">
	<id extension="3232732413" root="2.16.840.1.113883.3.989.2.1.3.20"/>
	<!-- ACK.M.1: Acknowledgement Batch Number -->
	<creationTime value="20260604225328-0400"/>
	...
	<!-- Ack Message #1 -->
	<MCCI_IN000002UV01>
		<id extension="896001" root="2.16.840.1.113883.3.989.2.1.3.19"/>
		...
		<attentionLine>
			...
			<value value="20260603171000-0400" xsi:type="TS"/>
...
1: Required Intervention (FDA.E.i.3.2h)  must always contain nullFlavour "NI" for a pre-market case
	...
	<attentionLine>
		...
		<value extension="811266" root="2.16.840.1.113883.3.989.2.1.3.21" xsi:type="II"/>
