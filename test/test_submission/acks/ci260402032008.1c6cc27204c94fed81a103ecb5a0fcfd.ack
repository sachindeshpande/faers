<?xml version="1.0" encoding="UTF-8"?><MCCI_IN200101UV01 xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ITSVersion="XML_1.0" xsi:schemaLocation="urn:hl7-org:v3 MCCI_IN200101UV01.xsd">
	<id extension="3228940525" root="2.16.840.1.113883.3.989.2.1.3.20"/>
	<!-- ACK.M.1: Acknowledgement Batch Number -->
	<creationTime value="20260401232516-0400"/>
	...
	<!-- Ack Message #1 -->
	<MCCI_IN000002UV01>
		<id extension="830196" root="2.16.840.1.113883.3.989.2.1.3.19"/>
		...
		<acknowledgement typeCode="CR">
			...
			<acknowledgementDetail>
				<text>org.xml.sax.SAXParseException; lineNumber: 43; columnNumber: 26; cvc-complex-type.2.4.a: Invalid content was found starting with element '{"urn:hl7-org:v3":effectiveTime}'. One of '{"urn:hl7-org:v3":text, "urn:hl7-org:v3":statusCode}' is expected.</text>
