<?xml version="1.0" encoding="UTF-8"?><MCCI_IN200101UV01 xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ITSVersion="XML_1.0" xsi:schemaLocation="urn:hl7-org:v3 MCCI_IN200101UV01.xsd">
	<id extension="3232714895" root="2.16.840.1.113883.3.989.2.1.3.20"/>
	<!-- ACK.M.1: Acknowledgement Batch Number -->
	<creationTime value="20260603181314-0400"/>
	...
	<!-- Ack Message #1 -->
	<MCCI_IN000002UV01>
		<id extension="895619" root="2.16.840.1.113883.3.989.2.1.3.19"/>
		...
		<receiver typeCode="RCV">
			<device classCode="DEV" determinerCode="INSTANCE">
				<id extension="" root="2.16.840.1.113883.3.989.2.1.3.16"/>
				<!-- ACK.B.r.3: ICSR Message ACK Receiver -->
			</device>
		</receiver>
		<sender typeCode="SND">
			<device classCode="DEV" determinerCode="INSTANCE">
				<id extension="" root="2.16.840.1.113883.3.989.2.1.3.15"/>
		...
		<acknowledgement typeCode="CR">
			...
			<targetMessage>
				<id extension="SR-CASE-20260513-MEGA" root="2.16.840.1.113883.3.989.2.1.3.1"/>
				<!-- ACK.B.r.1: ICSR Message Number -->
			</targetMessage>
			<acknowledgementDetail>
				<text>org.xml.sax.SAXParseException; lineNumber: 203; columnNumber: 83; cvc-complex-type.2.4.a: Invalid content was found starting with element '{"urn:hl7-org:v3":effectiveTime}'. One of '{"urn:hl7-org:v3":rateQuantity, "urn:hl7-org:v3":doseCheckQuantity, "urn:hl7-org:v3":maxDoseQuantity, "urn:hl7-org:v3":administrationUnitCode, "urn:hl7-org:v3":consumable, "urn:hl7-org:v3":performer, "urn:hl7-org:v3":author, "urn:hl7-org:v3":location, "urn:hl7-org:v3":outboundRelationship1, "urn:hl7-org:v3":outboundRelationship2, "urn:hl7-org:v3":inboundRelationship}' is expected.</text>
	...
	<sender typeCode="SND">
		<device classCode="DEV" determinerCode="INSTANCE">
			<id extension="CDER_IND" root="2.16.840.1.113883.3.989.2.1.3.17"/>
	...
	<attentionLine>
		...
		<value extension="" root="2.16.840.1.113883.3.989.2.1.3.21" xsi:type="II"/>
	...
	<acknowledgement typeCode="AR">
		...
		<targetBatch>
			<id extension="DeepQuenceTest-20260513-IND-93e06314-8b2f-4d4d-83be-51fc82030aa0" root="2.16.840.1.113883.3.989.2.1.3.22"/>
