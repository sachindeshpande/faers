<?xml version="1.0" encoding="UTF-8"?><MCCI_IN200101UV01 xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ITSVersion="XML_1.0" xsi:schemaLocation="urn:hl7-org:v3 MCCI_IN200101UV01.xsd">
	<id extension="3230774477" root="2.16.840.1.113883.3.989.2.1.3.20"/>
	<!-- ACK.M.1: Acknowledgement Batch Number -->
	<creationTime value="20260507004914-0400"/>
	...
	<!-- Ack Message #1 -->
	<MCCI_IN000002UV01>
		<id extension="858369" root="2.16.840.1.113883.3.989.2.1.3.19"/>
		...
		<acknowledgement typeCode="CR">
			...
			<targetMessage>
				<id extension="SR-CASE-20260507-INDT03" root="2.16.840.1.113883.3.989.2.1.3.1"/>
				<!-- ACK.B.r.1: ICSR Message Number -->
			</targetMessage>
			<acknowledgementDetail>
				<text>Safety report not loaded; Validated against 2.18 business rules;
Rejections:
1: N.1.5 contains future date.
2: File sent with  AS2 header “CDER_IND” must have N.1.4 = "ZZFDATST_PREMKT" and N.2.r.3 = "CDER_IND"
3: FDA.C.5.6.r is not allowed when N.2.r.3 = "CDER" or "CBER" and N.1.4 = "ZZFDA".
4: C.1.2 contains future date.
5: FDA.C.5.5a is not allowed when N.2.r.3 = "CDER" or "CBER" and N.1.4 = "ZZFDA"
6: N.2.r.4 contains future date.
Warnings:
1: FDA.C.5.6.r is invalid for the Center specified in N.2.r.3.
2: FDA.C.5.6.r is invalid for the Center specified in N.2.r.3.
</text>
	...
	<attentionLine>
		...
		<value extension="774195" root="2.16.840.1.113883.3.989.2.1.3.21" xsi:type="II"/>
	...
	<acknowledgement typeCode="AR">
		...
		<targetBatch>
			<id extension="DeepQuenceTest-20260507-5bb00604-76c9-454e-ba60-9a47eb491299" root="2.16.840.1.113883.3.989.2.1.3.22"/>
