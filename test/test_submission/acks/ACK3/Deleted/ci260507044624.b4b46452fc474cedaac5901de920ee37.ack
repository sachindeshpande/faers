<?xml version="1.0" encoding="UTF-8"?><MCCI_IN200101UV01 xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ITSVersion="XML_1.0" xsi:schemaLocation="urn:hl7-org:v3 MCCI_IN200101UV01.xsd">
	<id extension="3230774501" root="2.16.840.1.113883.3.989.2.1.3.20"/>
	<!-- ACK.M.1: Acknowledgement Batch Number -->
	<creationTime value="20260507004945-0400"/>
	...
	<!-- Ack Message #1 -->
	<MCCI_IN000002UV01>
		<id extension="858373" root="2.16.840.1.113883.3.989.2.1.3.19"/>
		...
		<acknowledgement typeCode="CR">
			...
			<targetMessage>
				<id extension="SR-CASE-20260507-INDT07" root="2.16.840.1.113883.3.989.2.1.3.1"/>
...
2: N.1.5 contains future date.
3: C.1.2 contains future date.
4: File sent with  AS2 header “CDER_IND” must have N.1.4 = "ZZFDATST_PREMKT" and N.2.r.3 = "CDER_IND"
5: FDA.C.5.6.r is not allowed when N.2.r.3 = "CDER" or "CBER" and N.1.4 = "ZZFDA".
6: FDA.C.5.5a is not allowed when N.2.r.3 = "CDER" or "CBER" and N.1.4 = "ZZFDA"
Warnings:
1: FDA.C.5.6.r is invalid for the Center specified in N.2.r.3.
	...
	<attentionLine>
		...
		<value extension="774199" root="2.16.840.1.113883.3.989.2.1.3.21" xsi:type="II"/>
	...
	<acknowledgement typeCode="AR">
		...
		<targetBatch>
			<id extension="DeepQuenceTest-20260507-634ab832-ddf9-4ebb-8e9e-f98dd2a40d53" root="2.16.840.1.113883.3.989.2.1.3.22"/>
