<?xml version="1.0" encoding="UTF-8"?><MCCI_IN200101UV01 xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ITSVersion="XML_1.0" xsi:schemaLocation="urn:hl7-org:v3 MCCI_IN200101UV01.xsd">
	<id extension="3230760507" root="2.16.840.1.113883.3.989.2.1.3.20"/>
	<!-- ACK.M.1: Acknowledgement Batch Number -->
	<creationTime value="20260506203308-0400"/>
	...
	<!-- Ack Message #1 -->
	<MCCI_IN000002UV01>
		<id extension="858340" root="2.16.840.1.113883.3.989.2.1.3.19"/>
		...
		<acknowledgement typeCode="CR">
			...
			<targetMessage>
				<id extension="SR-CASE-20260506-INDT03" root="2.16.840.1.113883.3.989.2.1.3.1"/>
				<!-- ACK.B.r.1: ICSR Message Number -->
			</targetMessage>
			<acknowledgementDetail>
				<text>Safety report not loaded; Validated against 2.18 business rules;
Rejections:
1: File sent with AS2 header “CDER” must have N.1.4 = "ZZFDATST" and N.2.r.3 = "CDER"
Warnings:
...
2: FDA.C.5.6.r is invalid for the Center specified in N.2.r.3.
	...
	<attentionLine>
		...
		<value extension="774166" root="2.16.840.1.113883.3.989.2.1.3.21" xsi:type="II"/>
	...
	<attentionLine>
		...
		<value value="20260506201458-0400" xsi:type="TS"/>
		<!-- ACK.A.3: Date of ICSR Batch Transmission -->
	</attentionLine>
	<acknowledgement typeCode="AR">
		<!-- ACK.A.4: Transmission Acknowledgement Code -->
		<targetBatch>
			<id extension="DeepQuenceTest-20260506-2e3d234f-6621-4f89-beca-da3ec76f79cb" root="2.16.840.1.113883.3.989.2.1.3.22"/>
