<?xml version="1.0" encoding="UTF-8"?><MCCI_IN200101UV01 xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ITSVersion="XML_1.0" xsi:schemaLocation="urn:hl7-org:v3 MCCI_IN200101UV01.xsd">
	<id extension="3230774499" root="2.16.840.1.113883.3.989.2.1.3.20"/>
	<!-- ACK.M.1: Acknowledgement Batch Number -->
	<creationTime value="20260507004940-0400"/>
	...
	<!-- Ack Message #1 -->
	<MCCI_IN000002UV01>
		<id extension="858371" root="2.16.840.1.113883.3.989.2.1.3.19"/>
		...
		<attentionLine>
			...
			<value value="20260507100000-0400" xsi:type="TS"/>
			<!-- ACK.B.r.5: Date of ICSR Message Creation -->
		</attentionLine>
		<acknowledgement typeCode="CR">
			<!-- ACK.B.r.6: Acknowledgement Code for a ICSR Message -->
			<targetMessage>
				<id extension="SR-CASE-20260507-INDT05" root="2.16.840.1.113883.3.989.2.1.3.1"/>
				<!-- ACK.B.r.1: ICSR Message Number -->
			</targetMessage>
			<acknowledgementDetail>
				<text>Safety report not loaded; Validated against 2.18 business rules;
Rejections:
1: File sent with  AS2 header “CDER_IND” must have N.1.4 = "ZZFDATST_PREMKT" and N.2.r.3 = "CDER_IND"
2: FDA.C.5.5a is not allowed when N.2.r.3 = "CDER" or "CBER" and N.1.4 = "ZZFDA"
3: FDA.C.5.6.r is not allowed when N.2.r.3 = "CDER" or "CBER" and N.1.4 = "ZZFDA".
4: N.2.r.4 contains future date.
5: N.1.5 contains future date.
6: If Combination Product Report Flag (FDA.C.1.12) is False or NI and Locally Expedited (C.1.7) is True, value in Local Criteria Report Type (FDA.C.1.7.1) must be 15 day.
7: C.1.2 contains future date.
Warnings:
1: FDA.C.5.6.r is invalid for the Center specified in N.2.r.3.
	...
	<attentionLine>
		...
		<value extension="774197" root="2.16.840.1.113883.3.989.2.1.3.21" xsi:type="II"/>
	...
	<attentionLine>
		...
		<value value="20260507130000-0400" xsi:type="TS"/>
		<!-- ACK.A.3: Date of ICSR Batch Transmission -->
	</attentionLine>
	<acknowledgement typeCode="AR">
		<!-- ACK.A.4: Transmission Acknowledgement Code -->
		<targetBatch>
			<id extension="DeepQuenceTest-20260507-8a9866be-3369-4080-921a-172b8ec06337" root="2.16.840.1.113883.3.989.2.1.3.22"/>
