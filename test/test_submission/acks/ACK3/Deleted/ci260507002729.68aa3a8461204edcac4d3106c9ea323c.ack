<?xml version="1.0" encoding="UTF-8"?><MCCI_IN200101UV01 xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ITSVersion="XML_1.0" xsi:schemaLocation="urn:hl7-org:v3 MCCI_IN200101UV01.xsd">
	<id extension="3230760495" root="2.16.840.1.113883.3.989.2.1.3.20"/>
	<!-- ACK.M.1: Acknowledgement Batch Number -->
	<creationTime value="20260506203300-0400"/>
	...
	<!-- Ack Message #1 -->
	<MCCI_IN000002UV01>
		<id extension="858339" root="2.16.840.1.113883.3.989.2.1.3.19"/>
		...
		<attentionLine>
			...
			<value value="20260316100000-0400" xsi:type="TS"/>
			<!-- ACK.B.r.5: Date of ICSR Message Creation -->
		</attentionLine>
		<acknowledgement typeCode="CR">
			<!-- ACK.B.r.6: Acknowledgement Code for a ICSR Message -->
			<targetMessage>
				<id extension="SR-CASE-20260506-INDT02" root="2.16.840.1.113883.3.989.2.1.3.1"/>
...
1: FDA.C.5.6.r is invalid for the Center specified in N.2.r.3.
	...
	<attentionLine>
		...
		<value extension="774165" root="2.16.840.1.113883.3.989.2.1.3.21" xsi:type="II"/>
	...
	<acknowledgement typeCode="AR">
		...
		<targetBatch>
			<id extension="DeepQuenceTest-20260506-c50dda12-5d50-4b03-9351-d9bcf59ec463" root="2.16.840.1.113883.3.989.2.1.3.22"/>
