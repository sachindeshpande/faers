<?xml version="1.0" encoding="UTF-8"?><MCCI_IN200101UV01 xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ITSVersion="XML_1.0" xsi:schemaLocation="urn:hl7-org:v3 MCCI_IN200101UV01.xsd">
	<id extension="3228815566" root="2.16.840.1.113883.3.989.2.1.3.20"/>
	<!-- ACK.M.1: Acknowledgement Batch Number -->
	<creationTime value="20260331203301-0400"/>
	...
	<!-- Ack Message #1 -->
	<MCCI_IN000002UV01>
		<id extension="827042" root="2.16.840.1.113883.3.989.2.1.3.19"/>
		...
		<acknowledgement typeCode="CR">
			...
			<acknowledgementDetail>
				<text>org.xml.sax.SAXParseException; lineNumber: 10; columnNumber: 29; cvc-complex-type.2.4.a: Invalid content was found starting with element '{"urn:hl7-org:v3":processingCode}'. One of '{"urn:hl7-org:v3":batchComment, "urn:hl7-org:v3":transmissionQuantity, "urn:hl7-org:v3":batchTotalNumber, "urn:hl7-org:v3":PORR_IN049016UV, "urn:hl7-org:v3":PORR_IN049017UV, "urn:hl7-org:v3":PORR_IN049018UV}' is expected.</text>
	...
	<sender typeCode="SND">
		<device classCode="DEV" determinerCode="INSTANCE">
			<id extension="2" root="2.16.840.1.113883.3.989.2.1.3.17"/>
	...
	<acknowledgement typeCode="AR">
		...
		<targetBatch>
			<id extension="SINGLE-1774973691303" root="2.16.840.1.113883.3.989.2.1.3.22"/>
