<?xml version="1.0" encoding="UTF-8"?><MCCI_IN200101UV01 xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ITSVersion="XML_1.0" xsi:schemaLocation="urn:hl7-org:v3 MCCI_IN200101UV01.xsd">
	<id extension="3229490566" root="2.16.840.1.113883.3.989.2.1.3.20"/>
	<!-- ACK.M.1: Acknowledgement Batch Number -->
	<creationTime value="20260408020151-0400"/>
	...
	<!-- Ack Message #1 -->
	<MCCI_IN000002UV01>
		<id extension="834431" root="2.16.840.1.113883.3.989.2.1.3.19"/>
...
Rejections:
1: Data value required for tag C.3.4.7.
2: D.7.2 must be provided when D.7.1.r.1b is not provided.
</text>
	...
	<attentionLine>
		...
		<value extension="750312" root="2.16.840.1.113883.3.989.2.1.3.21" xsi:type="II"/>
