<?xml version="1.0" encoding="UTF-8"?><MCCI_IN200101UV01 xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ITSVersion="XML_1.0" xsi:schemaLocation="urn:hl7-org:v3 MCCI_IN200101UV01.xsd">
	<id extension="3229446062" root="2.16.840.1.113883.3.989.2.1.3.20"/>
	<!-- ACK.M.1: Acknowledgement Batch Number -->
	<creationTime value="20260407143401-0400"/>
	...
	<!-- Ack Message #1 -->
	<MCCI_IN000002UV01>
		<id extension="832162" root="2.16.840.1.113883.3.989.2.1.3.19"/>
...
Rejections:
1: Data value required for tag C.3.3.2.
2: Data value required for tag C.1.7.
3: Data value required for tag E.i.3.2c.
4: Data value required for tag C.1.8.2.
5: Data value required for tag E.i.3.2e.
6: Data value required for tag E.i.3.2f.
7: Data value required for tag C.3.4.2.
8: Required Intervention (FDA.E.i.3.2h)  is mandatory for a post-market case.
9: Data value required for tag C.3.4.5.
10: Data value required for tag E.i.3.2a.
11: Data value required for tag C.3.4.8.
12: Required Intervention (FDA.E.i.3.2h)  is mandatory for a post-market case.
13: Data value required for tag C.3.3.1.
14: Data value required for tag C.1.3.
15: Data value required for tag E.i.3.2f.
16: Data value required for tag E.i.3.2b.
17: Data value required for tag FDA.C.1.7.1.
18: Data value required for tag C.1.6.1.
19: Data value required for tag E.i.3.2e.
20: Data value required for tag C.3.3.3.
21: Data value required for tag C.1.9.1.
22: Data value required for tag C.3.4.6.
23: Data value required for tag E.i.3.2b.
24: Data value required for tag FDA.C.1.12.
25: Data value required for tag E.i.3.2d.
26: Data value required for tag E.i.7.
27: Data value required for tag E.i.3.2a.
28: D.7.2 must be provided when D.7.1.r.1b is not provided.
29: Data value required for tag E.i.3.2d.
30: Data value required for tag C.3.4.3.
31: Data value required for tag C.3.4.7.
32: Data value required for tag C.3.4.4.
33: Data value required for tag C.3.3.5.
34: Data value required for tag C.3.1.
35: Data value required for tag E.i.3.2c.
36: Data value required for tag C.3.4.1.
37: Data value required for tag E.i.7.
</text>
	...
	<attentionLine>
		...
		<value extension="748045" root="2.16.840.1.113883.3.989.2.1.3.21" xsi:type="II"/>
