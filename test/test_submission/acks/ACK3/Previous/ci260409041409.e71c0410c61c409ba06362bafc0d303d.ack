<?xml version="1.0" encoding="UTF-8"?><MCCI_IN200101UV01 xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ITSVersion="XML_1.0" xsi:schemaLocation="urn:hl7-org:v3 MCCI_IN200101UV01.xsd">
	<id extension="3229574298" root="2.16.840.1.113883.3.989.2.1.3.20"/>
	<!-- ACK.M.1: Acknowledgement Batch Number -->
	<creationTime value="20260409002102-0400"/>
	...
	<!-- Ack Message #1 -->
	<MCCI_IN000002UV01>
		<id extension="836697" root="2.16.840.1.113883.3.989.2.1.3.19"/>
		...
		<acknowledgement typeCode="CR">
			...
			<acknowledgementDetail>
				<text>org.xml.sax.SAXParseException; lineNumber: 429; columnNumber: 40; cvc-complex-type.2.4.a: Invalid content was found starting with element '{"urn:hl7-org:v3":primaryRole}'. One of '{"urn:hl7-org:v3":outboundRelationship, "urn:hl7-org:v3":subjectOf1, "urn:hl7-org:v3":subjectOf2}' is expected.</text>
	...
	<acknowledgement typeCode="AR">
		...
		<targetBatch>
			<id extension="DeepQuenceTest-20260409-v33-c4f1a082-8d5b-4e2c-b9d7-3e5f6a1c8d05" root="2.16.840.1.113883.3.989.2.1.3.22"/>
