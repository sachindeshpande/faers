<?xml version="1.0" encoding="UTF-8"?><MCCI_IN200101UV01 xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ITSVersion="XML_1.0" xsi:schemaLocation="urn:hl7-org:v3 MCCI_IN200101UV01.xsd">
	<id extension="3231294059" root="2.16.840.1.113883.3.989.2.1.3.20"/>
	<!-- ACK.M.1: Acknowledgement Batch Number -->
	<creationTime value="20260512230918-0400"/>
	...
	<!-- Ack Message #1 -->
	<MCCI_IN000002UV01>
		<id extension="864361" root="2.16.840.1.113883.3.989.2.1.3.19"/>
		...
		<attentionLine>
			...
			<value value="20260512010000-0400" xsi:type="TS"/>
			<!-- ACK.B.r.5: Date of ICSR Message Creation -->
		</attentionLine>
		<acknowledgement typeCode="CR">
			<!-- ACK.B.r.6: Acknowledgement Code for a ICSR Message -->
			<targetMessage>
				<id extension="SR-CASE-20260512-MEGA-IND" root="2.16.840.1.113883.3.989.2.1.3.1"/>
				<!-- ACK.B.r.1: ICSR Message Number -->
			</targetMessage>
			<acknowledgementDetail>
				<text>Safety report not loaded; Validated against 2.18 business rules;
Rejections:
1: Required Intervention (FDA.E.i.3.2h)  must always contain nullFlavour "NI" for a pre-market case
2: IND number of cross reported IND (FDA.C.5.6.r) is mandatory when IND Number where AE Occurred (FDA.C.5.5a) is not empty.
3: Required Intervention (FDA.E.i.3.2h)  must always contain nullFlavour "NI" for a pre-market case
4: N.1.4 = "ZZFDA_PREMKT" and N.2.r.3 = 'CDER_IND' or 'CBER_IND' and C.1.3 = 1, then C.5.4 must not be provided.
</text>
	...
	<attentionLine>
		...
		<value extension="780152" root="2.16.840.1.113883.3.989.2.1.3.21" xsi:type="II"/>
	...
	<acknowledgement typeCode="AR">
		...
		<targetBatch>
			<id extension="DeepQuenceTest-20260512-IND-d24dea4f-893b-40de-831c-dbd6b98b5501" root="2.16.840.1.113883.3.989.2.1.3.22"/>
