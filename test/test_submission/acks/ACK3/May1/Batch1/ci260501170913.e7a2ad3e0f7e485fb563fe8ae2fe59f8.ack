<?xml version="1.0" encoding="UTF-8"?><MCCI_IN200101UV01 xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ITSVersion="XML_1.0" xsi:schemaLocation="urn:hl7-org:v3 MCCI_IN200101UV01.xsd">
	<id extension="3230423431" root="2.16.840.1.113883.3.989.2.1.3.20"/>
	...
	<!-- Ack Message #1 -->
	<MCCI_IN000002UV01>
		<id extension="854546" root="2.16.840.1.113883.3.989.2.1.3.19"/>
		...
		<acknowledgement typeCode="CR">
			...
			<targetMessage>
				<id extension="SR-CASE-EXAMPLE-TCG01" root="2.16.840.1.113883.3.989.2.1.3.1"/>
...
1: If Combination Product Report Flag (FDA.C.1.12) is False or NI and Locally Expedited (C.1.7) is False or NI, value in Local Criteria Report Type (FDA.C.1.7.1) must be Non Expedited AE (Periodic).
	...
	<attentionLine>
		...
		<value extension="770281" root="2.16.840.1.113883.3.989.2.1.3.21" xsi:type="II"/>
	...
	<acknowledgement typeCode="AR">
		...
		<targetBatch>
			<id extension="DeepQuenceTest-20260429-7c2f14be-757a-4d1f-ba36-615de011c02d" root="2.16.840.1.113883.3.989.2.1.3.22"/>
