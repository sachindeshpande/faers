<?xml version="1.0" encoding="UTF-8"?><MCCI_IN200101UV01 xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ITSVersion="XML_1.0" xsi:schemaLocation="urn:hl7-org:v3 MCCI_IN200101UV01.xsd">
	<id extension="3230423426" root="2.16.840.1.113883.3.989.2.1.3.20"/>
	<!-- ACK.M.1: Acknowledgement Batch Number -->
	<creationTime value="20260501131434-0400"/>
	...
	<!-- Ack Message #1 -->
	<MCCI_IN000002UV01>
		<id extension="854544" root="2.16.840.1.113883.3.989.2.1.3.19"/>
...
Rejections:
1: If Combination Product Report Flag (FDA.C.1.12) is False or NI and Locally Expedited (C.1.7) is False or NI, value in Local Criteria Report Type (FDA.C.1.7.1) must be Non Expedited AE (Periodic).
</text>
	...
	<attentionLine>
		...
		<value extension="770279" root="2.16.840.1.113883.3.989.2.1.3.21" xsi:type="II"/>
	...
	<acknowledgement typeCode="AR">
		...
		<targetBatch>
			<id extension="DeepQuenceTest-20260430-05663450-a455-4dd8-99d1-04461d29b2b3" root="2.16.840.1.113883.3.989.2.1.3.22"/>
