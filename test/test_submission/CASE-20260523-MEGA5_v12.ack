<?xml version="1.0" encoding="UTF-8"?><MCCI_IN200101UV01 xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ITSVersion="XML_1.0" xsi:schemaLocation="urn:hl7-org:v3 MCCI_IN200101UV01.xsd">
	<id extension="3232461273" root="2.16.840.1.113883.3.989.2.1.3.20"/>
	<!-- ACK.M.1: Acknowledgement Batch Number -->
	<creationTime value="20260529190508-0400"/>
	...
	<!-- Ack Message #1 -->
	<MCCI_IN000002UV01>
		<id extension="891962" root="2.16.840.1.113883.3.989.2.1.3.19"/>
		...
		<attentionLine>
			...
			<value value="20260526010000-0400" xsi:type="TS"/>
			<!-- ACK.B.r.5: Date of ICSR Message Creation -->
		</attentionLine>
		<acknowledgement typeCode="CA">
			<!-- ACK.B.r.6: Acknowledgement Code for a ICSR Message -->
			<targetMessage>
				<id extension="SR-CASE-20260529-MEGA5v12" root="2.16.840.1.113883.3.989.2.1.3.1"/>
	...
	<attentionLine>
		...
		<value extension="807564" root="2.16.840.1.113883.3.989.2.1.3.21" xsi:type="II"/>
	...
	<acknowledgement typeCode="AA">
		...
		<targetBatch>
			<id extension="DeepQuenceTest-20260529-TCM12v12-8c89bf4e" root="2.16.840.1.113883.3.989.2.1.3.22"/>
